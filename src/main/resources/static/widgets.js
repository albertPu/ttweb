(function (e, t, r) {
    var i = e[r] = e[r] || {}, s = 2, n = 1, a = 0, o = a,
        l = "assets/inplaymatrix/widgets/js/widgets.js?v=494116499".split(":"), p = "".split(":"), u = {}, c = "",
        d = false, f = "" === "1", h = parseInt("3", 10), g = "", v = false, m = true, y = true, _ = false, $ = "",
        w = "", b = t.currentScript, S, C = false, I = {wlLoaded: +new Date};
    ...
    var j = {};
    var D = function (e, t) {
        var r = t.split("."), s = r.pop(), n = 0, a = e.length;
        var o = SRUtil.getPropertyArray(i, r), l;
        if (o[s]) {
            for (; n < a; n++) {
                l = o[s].apply(o, e[n])
            }
    ...
    var F = function (e, t) {
        if (!y) {
            var r = e.split("."), n = r.pop(), a = SRUtil.getPropertyArray(i, r), l = a[n];
            return function () {
    ...
    var M = function () {
        ...
        var r = SRUtil.extend(true, {
            ...
            client: {
                ...
                s4clientid: "160",
                bookmakerId: "7900",
                oddsBookmakerId: "6666",
                build: "clientsetup-widgets/master/#1026/4c01090/2018-12-18-11:27:28-1545128848-18/12/18 10:27:28 GMT"
            },
            query: {
            ...
            widget: {
                ...
                matchId: _,
                version: '3694430775',
                cssVersion: '2727270510',
                cssClient: "inplaymatrix",
                preferHttps: f,
                queryRoot: S
            },
            eventpoller: {feeds: {event_fullfeed: {disabled: true}, event_get: {disabled: true}}}
        }, t, e.SRConfig || {});
        K(r);
        o = s;
